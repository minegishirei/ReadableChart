...
class Factory{
    ...
    [void]buildPlantUML([string]$inputXmlFile, [string]$outputUmlFile){
        $XmlObj = [XML](Get-Content $inputXmlFile) 
        $XmlObj
    }
}
...
$factory.run()
$factory.buildXML("/Users/minegishirei/myworking/ReadableChart/main/src.xml")
